...
//
//public class TripFeederDataOld implements Parcelable {
//
...
//	private int status;
//
//	protected TripFeederDataOld(Parcel in) {
...
//	}
//
//	public TripFeederDataOld(){
//
//	}
//
//	public static final Creator<TripFeederDataOld> CREATOR = new Creator<TripFeederDataOld>() {
//		@Override
//		public TripFeederDataOld createFromParcel(Parcel in) {
//			return new TripFeederDataOld(in);
//		}
//
//		@Override
//		public TripFeederDataOld[] newArray(int size) {
//			return new TripFeederDataOld[size];
//		}
//	};
//
