...
//
//public class DetailTripSopirDataOld implements Parcelable {
//
...
//	private int status;
//
//	public DetailTripSopirDataOld(){
//
//	}
//
//	protected DetailTripSopirDataOld(Parcel in) {
...
//	}
//
//	public static final Creator<DetailTripSopirDataOld> CREATOR = new Creator<DetailTripSopirDataOld>() {
//		@Override
//		public DetailTripSopirDataOld createFromParcel(Parcel in) {
//			return new DetailTripSopirDataOld(in);
//		}
//
//		@Override
//		public DetailTripSopirDataOld[] newArray(int size) {
//			return new DetailTripSopirDataOld[size];
//		}
//	};
//
